 ...
 * @returns {string}
 */
export function formatTime(time: any, option: string): string|null {
  if (('' + time).length === 10) {
 ...
 * @returns {Array}
 */
export function param(json: any): string|Array<any> {
  if (!json) return ''
  return cleanArray(
 ...
 * @returns {Object}
 */
export function objectMerge(target: any, source: any): Object {
